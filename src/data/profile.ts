export const profile = {
  ...
  tagline: 'Specialized in vulnerability assessment, penetration testing, and securing web applications. Helping organizations identify and remediate security risks.',
  email: 'contact@saqibrahi.com',
  ...
  social: {
    ...
    linkedin: 'https://www.linkedin.com/in/saqib-rahi/',
    email: 'saqibrahi@example.com'
  }
}
